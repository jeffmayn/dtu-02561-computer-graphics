...
function createSphere(gl, program){
  ...
  var ka_input = vec4(ka);

  ambientProduct = mult(lightAmbient, materialAmbient);
  ambientProdcut2 = mult(ambientProduct,ka);
 ...
 gl.uniform4fv(  gl.getUniformLocation(program, "ambientProduct"), ambientProdcut2);
